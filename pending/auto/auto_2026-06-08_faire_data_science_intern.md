...
- **evidence_notes:** Auto-verified: official Greenhouse page returned HTTP 200 on 2026-06-08; title 'Data Science Intern' detected; apply flow detected; location 'Toronto, ON, Canada; Kitchener, ON, Canada; SF'.
...
- **risk_flags:** Auto-discovered (needs manual review), Citizenship unclear, Sponsorship unclear, Compensation unclear, Graduate/advanced-degree-only (not undergraduate-focused)
